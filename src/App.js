...
function MainComponent() {
  ...
  return (
    <div className="App">
      ...
      <div className="kid">
        <img className="kid-img" src={bull} />
      </div>
      <div className={`main-section ` + (walletConnected ? "connected" : " ")}>
        {
          !isStarted && (
            <div className="count-down"> 
              <Countdown className="mt-5" date={new Date("2022-11-06T13:00:00-0500")} renderer={renderer} />
        ...
        }
        {
          isStarted && walletConnected && (
            <>
             ...
             <div className="totalNumber"> {totalSupply} </div>
                <div className="qty">
